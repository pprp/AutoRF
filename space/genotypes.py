...
# for cifar100
Q1 = Genotype(normal=[('max_pool_3x3', 0), ('avg_pool_5x5', 0), ('max_pool_7x7', 1), ('noise', 1), ('noise', 2), ('noise', 0)], normal_concat=range(0, 4))
...
M2 = Genotype(normal=[('avg_pool_7x7', 0), ('noise', 0), ('noise', 1), ('noise', 1), ('noise', 2), ('noise', 0)], normal_concat=range(0, 4))

# for resnet18 cifar100 
M3 = Genotype(normal=[('max_pool_3x3', 0), ('max_pool_7x7', 1), ('avg_pool_7x7', 0), ('max_pool_5x5', 1), ('max_pool_3x3', 0), ('max_pool_5x5', 2)], normal_concat=range(0, 4))
