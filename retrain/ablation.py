...
class PluginRF(nn.Module):
    def __init__(self,
        ...
        if self.spatial:
            ...
            self.bottle = nn.Conv2d(inplanes,
                                    inplanes // self.reduction_ratio,
                                    kernel_size=1,
                                    stride=1,
                                    padding=0,
                                    bias=False)
            self.conv1x1 = nn.Conv2d(inplanes // self.reduction_ratio *
                                     self._steps,
                                     inplanes,
                                     kernel_size=1,
                                     stride=1,
...
if __name__ == '__main__':
    ...
    m = plug_spatial_channel_resnet20(
        genotype=Genotype(normal=[('max_pool_3x3',
                                   0), ('avg_pool_5x5',
                                        0), ('max_pool_7x7',
                                             1), ('noise', 1), ('noise',
                                                                2), ('noise',
