...
from utils.utils import AvgrageMeter, Cutout, accuracy
...
def load_cifar(data_loader, batch_size=256, num_workers=4):
    ...
    # DataLoader
    train_set = data_loader(root='/data/public/cifar',
                            train=True,
                            download=True,
                            transform=train_transform)
    test_set = data_loader(root='/data/public/cifar',
                           train=False,
                           download=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model',
                        default='rf_resnet56',
                        type=str,
                        help='Name of model architecure')
    parser.add_argument('--arch',
                        default='P1',
                        type=str,
                        help='Name of model arch')
