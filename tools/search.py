...
parser.add_argument('--dataset',
                    type=str,
                    default='cifar10',
                    help='cifar10 or cifar100 or imagenet')
...
args.save = '{}-{}-{}-{}'.format(args.comments, args.model_name, args.save,
...
def train(train_queue, valid_queue, model, architect, criterion, optimizer,
    ...
    for step, (input, target) in enumerate(train_queue):
        ...
        if step % args.report_freq == 0:
            logging.info('train step:%03d loss:%.4f top1:%.3f top5:%.3f', step,
...
def infer(valid_queue, model, criterion):
    ...
    for step, (input, target) in enumerate(valid_queue):
        ...
        if step % args.report_freq == 0:
            logging.info('valid step:%03d loss:%.4f top1:%.3f top5:%.3f', step,
                         objs.avg, top1.avg, top5.avg)
